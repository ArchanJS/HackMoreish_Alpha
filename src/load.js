...
var loadState = {
    preload: function() {
        var loadingLabel = game.add.text(game.world.centerX, 150, 'Loading, Please hold on! :)', {
            fontSize: 96,
            fill: '#ffffff'
        });
        ...
        //load player 
        game.load.image('player', 'assets/character/face.png');
        ...
        game.load.image('help_image', 'assets/ui/htp.png');
