var menuState = {
    create: function() {
        ...
        this.title = game.add.image(game.world.centerX, 140,
            'title');
        this.title.anchor.setTo(0.5, 0.5);
        this.playButton = game.add.button(185, 200, 'play_button', this.startGame, this);
        this.tweenButtons(this.playButton);

        this.muteButton = game.add.button(110, 350, 'mute_button', this.muteSound, this);
        this.tweenButtons(this.muteButton);
        if (game.sound.mute) {
            this.muteButton.frame = 1;
        }

        this.helpButton = game.add.button(game.world.centerX, 350, 'help_button', this.helpPopup, this);
