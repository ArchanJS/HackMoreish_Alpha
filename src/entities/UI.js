...
UI.prototype = {
    create: function() {
        ...
        this.distanceTraveled = game.add.text(30, 100, this.distanceCounter + 'm', {
            fontSize: 48,
            fill: '#ffffff'
        });
        this.emptyHearts = game.add.tileSprite(30, 150, 96, 27, 'empty_heart');
        this.hearts = game.add.tileSprite(30, 150, 96, 27, 'full_heart');
